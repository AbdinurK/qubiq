...
export const transformation = deals => {
    ...
    deals.map(deal => arr.push({
        ...
        deal_date: deal?.transaction_date ? moment(deal?.transaction_date, 'DD.MM.YYYY').format('DD.MM.YYYY') : new Date().toLocaleDateString(),
        start_commission_date: moment(deal.date_of_deposit, 'DD.MM.YYYY').format('DD.MM.YYYY'),
        end_commission_date: deal.expiration_date_of_deposit ? moment(deal.expiration_date_of_deposit, 'DD.MM.YYYY').format('DD.MM.YYYY') : new Date().toLocaleDateString(),
